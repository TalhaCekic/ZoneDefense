...
namespace RobotRush
{
	...
	/// </summary>
	public class RRGStageSelector : MonoBehaviour 
	{
        ...
        void Start()
        {
            ...
            for ( index = 0; index < stages.Length; index++ )
            {
                ...
                stages[index].highscore = Mathf.RoundToInt(stages[index].highscore);
        ...
        public void ChangeStage( int changeValue )
        {
            ...
            if ( changeValue > 0 && buttonNextStage.GetComponent<Animation>() )
            {
                buttonNextStage.GetComponent<Animation>().Stop();
                buttonNextStage.GetComponent<Animation>().Play();
            }
            else if (changeValue < 0 && buttonPrevStage.GetComponent<Animation>())
            {
                buttonPrevStage.GetComponent<Animation>().Stop();
                buttonPrevStage.GetComponent<Animation>().Play();
            }
